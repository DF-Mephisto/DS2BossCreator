...
namespace entity_description
{
	...
	const DWORD64 movesetPointers[6][4] = {
		{ 0x16148F0, 0xD0, 0x7F8, 0x138 },
		{ 0x16148F0, 0xD0, 0x7F8, 0x180 },
		{ 0x16148F0, 0xD0, 0x7F8, 0x1C8 },
		{ 0x16148F0, 0xD0, 0x7F8, 0x60 },
		{ 0x16148F0, 0xD0, 0x7F8, 0xA8 },
		{ 0x16148F0, 0xD0, 0x7F8, 0xF0 }
	};
	...
	const DWORD64 weaponsPointers[6][4] = {
		{ 0x16148F0, 0xD0, 0x7F8, 0x130 },
		{ 0x16148F0, 0xD0, 0x7F8, 0x178 },
		{ 0x16148F0, 0xD0, 0x7F8, 0x1C0 },
		{ 0x16148F0, 0xD0, 0x7F0, 0x558 },
		{ 0x16148F0, 0xD0, 0x7F8, 0xA0 },
		{ 0x16148F0, 0xD0, 0x7F0, 0x5E8 }
	};
	extern EntityDescription weaponsDescriptions[weaponsEntriesCount];

	const int paramPointerLength = 4;
	const DWORD64 commonBulletParamPointer[] = { 0x16148F0, 0x60, 0x20, 0xD8 };
	const DWORD64 enemyBulletParamPointer[] = { 0x16148F0, 0x60, 0x30, 0xD8 };
	const DWORD64 worldBulletParamPointer[] = { 0x16148F0, 0x60, 0x40, 0xD8 };
	const DWORD64 moveParamPointer[] = { 0x16148F0, 0x18, 0x440, 0xD8 };
	const DWORD64 movesetParamPointer[] = { 0x16148F0, 0x18, 0x430, 0xD8 };
	const DWORD64 weaponsParamPointer[] = { 0x16148F0, 0x18, 0x420, 0xD8 };
